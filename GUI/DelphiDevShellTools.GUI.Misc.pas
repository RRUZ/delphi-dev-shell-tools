//**************************************************************************************************
//
// Unit DelphiDevShellTools.GUI.Misc
// GUI helpers for dialogs, console output, file operations, grids and network diagnostics.
...
//
// The Original Code is DelphiDevShellTools.GUI.Misc.pas.
//
